/*
  # Actualizar textos predeterminados de consentimientos

  1. Cambios
     - Actualizar el texto de consentimiento para incluir todas las variables
     - Actualizar el texto del tutor legal para incluir todas las variables
  
  2. Importancia
     - Asegura que el texto predeterminado incluya todas las etiquetas inteligentes
     - Permite personalización manteniendo las variables necesarias
*/
...
WHERE consent_text NOT LIKE '%{Nombre Artista}%' 
   OR tutor_consent_text NOT LIKE '%{Parentesco Tutor}%';