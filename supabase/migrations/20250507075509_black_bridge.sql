/*
  # Actualizar plantillas de consentimiento con todas las variables
  
  1. Cambios
     - Actualizar los textos de consentimiento en la tabla config
     - Asegurar que todos los textos contengan las variables necesarias
  
  2. Beneficios
     - Garantiza que todas las etiquetas dinámicas funcionan correctamente
     - Mejora la experiencia del usuario con textos personalizados
*/
