            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">
                  Usa {'{Nombre Cliente}'} para el nombre del cliente y {'{Nombre Estudio}'} para el nombre del estudio.
                </p>
                <textarea
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">
                  Variables disponibles: {'{Nombre Tutor}'}, {'{Rut Tutor}'}, {'{Nombre Cliente}'}, {'{Apellidos Cliente}'}, {'{Rut Cliente}'}, {'{Edad Cliente}'}, {'{Nombre Estudio}'}, {'{Direccion Estudio}'}
                </p>
                <textarea
                  id="textoTutorLegal"
